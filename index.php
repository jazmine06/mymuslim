                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="img/model1.jpg" alt="Image">
                        ...
                        <div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="img/model2.jpg" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4>
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">65 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3" style="height: 300px ;">
                        <img class="img-fluid" src="img/jubah.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">91 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3" style="height: 300px ;">
                        <img class="img-fluid" src="img/Kanayya-Outer.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">67 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3" style="height: 300px ; width: 300px; ;" >
                        <img class="img-fluid" src="img/rok2.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Skirt</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="" class="cat-img position-relative overflow-hidden mb-3" style="height: 300px ;">
                        <img class="img-fluid" src="img/kaftan.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Caftan</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">15 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3" style="height: 300px ;">
                        <img class="img-fluid" src="img/laki.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Boy's Clothes</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">15 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3" style="height: 300px ;">
                        <img class="img-fluid" src="img/gamis.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Girl's Clothes</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0" style="height: 284px ;">
                        <img class="img-fluid w-100" src="img/abaya syari.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Abaya Syar'i</h6>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0" style="height: 284px ;">
                        <img class="img-fluid w-100" src="img/gamis2.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Children's Robe</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp 70.000</h6><h6 class="text-muted ml-2"><del>Rp 75.000</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0" style="height: 284px ;">
                        <img class="img-fluid w-100" src="img/rok.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Simple Skirt</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp 60.000</h6>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0" style="height: 284px ;">
                        <img class="img-fluid w-100" src="img/tren.jpg" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">Korean Set</h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rp 200.000</h6>
                        </div>
                    </div>
