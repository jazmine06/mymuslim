            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="img/ankcewe.jpg" alt="" style="width: 50px;">White Robe</td>
                            <td class="align-middle">Rp 90.000</td>
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/ankcowo.jpg" alt="" style="width: 50px;">Boys Muslim Clothes</td>
                            <td class="align-middle">Rp 72.000</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button class="btn btn-sm btn-primary btn-minus" >
